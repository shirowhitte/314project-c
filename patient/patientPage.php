      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="#">
            ...
            <span class="links_name">Ongoing</span>
          </a>
        </li>
        <li>
          <a href="#">
             <i class='bx bx-history' ></i>
            <span class="links_name">Past Record</span>
          </a>
        </li>
    ...
    <div class="home-content">
      ...
      <div class="sales-boxes">
        <div class="recent-sales box">
          <div class="title">Electronic Prescription for Patient</div>
          
        </div>
        <div class="top-sales box">
          <div class="title">Prescription Date:  DD MM YYYY</div>
